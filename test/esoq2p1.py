#
# This file is not part of pyquat. It is included temporarily only for
# the purpose of comparing to the output of pyquat's own esoq2
# implementation. It is available in full, including with a C++
# imlementation, from Arseniy Potapov: https://github.com/muzhig/ESOQ2
# 
